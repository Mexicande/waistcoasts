...
public class Product implements Serializable {
    ...
    public static class PrdListBean implements Serializable ,Comparable<PrdListBean>{
        ...
        public int getOrderpm() {
            return orderpm;
        }

        public void setOrderpm(int orderpm) {
        ...
        @Override
        public int compareTo(@NonNull PrdListBean prdListBean) {
            return orderpm-prdListBean.getOrderpm();
        }
    }
